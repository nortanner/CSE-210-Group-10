...
class Actor:
    ...
    def __init__(self, width=20, height=23):
    ...
    def get_collision(self):
        """Gets the actor's collision rectangle.
        
        Returns:
            Collision: The actor's text collision rectangle.
        """
    ...
    def move_next(self, max_x, max_y, x_boundary=16):
        ...
        """
        x = (self._position.get_x() + self._velocity.get_x()) % (max_x - x_boundary)
